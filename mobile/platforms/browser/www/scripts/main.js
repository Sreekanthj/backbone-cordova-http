...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'container\'>\n    <h1>Test Page</h1>\n    <input id=\'inputText\' class=\'form-control\'></input>\n    <br>\n    <button id=\'getDataBtn\' class=\'btn btn-default\'>Get Data</button>\n    <div id=\'result\'></div>\n</div>\n\n';
...
define('views/home',[
  ...
  var HomeView = Backbone.View.extend({
    ...
    initialize: function () {
      ...
      this.listenTo(this.model, 'sync', this.renderData);
    },
...
require([
  ...
  Backbone.Model.prototype.fetchMobile = function(data){
      if(typeof data == 'undefined'){
        cordova.plugin.http.get(this.url, {'test':1}, { Origin: "null" }, function(response) {
            // prints 200
      ...
      cordova.plugin.http.post(this.url, data, { Origin: "null" }, function(response) {
        // prints 200
        console.log(response.status);
        try {
            console.log(response.data.message);
